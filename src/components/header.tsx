...
export default function Header({ currentPage }: HeaderProps) {
  ...
  return (
    <div className="border-b-2 border-b-headerBorder bg-headerBackground transition ease-in-out duration-1000">
      <div className="flex justify-between gap-x-4 w-[90%] mx-auto pt-5 sm:pt-7 md:pt-10 pb-3 sm:pb-5 md:pb-8">
        <div className="flex gap-x-1 flex-col sm:flex-row sm:items-center sm:gap-x-3">
          {pages.map((page) => {
            ...
            return (
              <p key={page} className="text-base md:text-xl text-primaryHeader">
        ...
        <div className="flex flex-wrap items-start sm:items-end justify-end max-w-[60%] -gap-y-5">
          <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-primaryHeader font-bold whitespace-nowrap">
            Ian Conceicao
          </div>
          <div className="text-base md:text-xl text-primaryText whitespace-nowrap -mt-5 sm:-mt-2">
            software engineer
          </div>
        </div>
      </div>
