  ...
  return (
    <div className="group w-full sm:w-1/2 md:w-1/3 justify-center pb-3 md:pb-5 px-3 md:px-5 outline-2">
      <a href={link} target="_blank">
        <p className="w-full text-center text-primaryHeader group-hover:text-secondaryHeader font-gopher font-bold italic text-3xl md:text-4xl lg:text-[2.6rem] mb-4">
          {projectTitle}
        </p>
        <Image
          src={img}
